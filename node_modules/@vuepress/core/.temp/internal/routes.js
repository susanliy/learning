...
import GlobalLayout from "D:\\学习\\vuepress-starter\\node_modules\\@vuepress\\core\\lib\\client\\components\\GlobalLayout.vue"
...
export const routes = [
  {
    ...
    beforeEnter: (to, from, next) => {
      ensureAsyncComponentsLoaded("Layout", "v-0a24e0ba").then(next)
    },
  },
  {
    name: "v-6a13eb1a",
    ...
    component: GlobalLayout,
    beforeEnter: (to, from, next) => {
      ensureAsyncComponentsLoaded("Layout", "v-6a13eb1a").then(next)
    },
  },
  {
    name: "v-6c1bc864",
    ...
    component: GlobalLayout,
    beforeEnter: (to, from, next) => {
      ensureAsyncComponentsLoaded("Layout", "v-6c1bc864").then(next)
    },
  },
  {
    path: "/index.html",
